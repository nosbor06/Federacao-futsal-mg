        ...
        <aside class="sidebar">
            ...
            <nav class="flex-grow-1 px-2 pt-2">
                ...
                <a href="{{ route('jogos.index') }}"
                    class="nav-link d-flex align-items-center gap-2 mb-1 {{ request()->routeIs('jogos.*') ? 'active' : '' }}">
                    <i class="bi bi-calendar-event"></i> Jogos
                </a>
            ...
            <div class="px-2 py-2" style="border-top: 1px solid rgba(255,255,255,.08);">
                <div class="d-flex align-items-center gap-2 p-2 rounded-2" style="background:rgba(255,255,255,.05);">
                    ...
                    <div class="flex-grow-1 overflow-hidden">
                        <div class="text-white fw-semibold text-truncate" style="font-size:12.5px;">
                            {{ auth()->user()->nome }}</div>
